        ...
        <div className="flex flex-col gap-3 sm:flex-row sm:items-start sm:gap-5">
          ...
          <div>
            ...
            <p className="text-sm leading-relaxed text-gray-600">
              <span className="font-semibold text-ku-green">ศูนย์พัฒนานิสิตสู่ความเป็นเลิศ (SDEC)</span>{' '}
              คือองค์กรนิสิตที่มุ่งเสริมสร้างศักยภาพด้านวิชาการ ทักษะอาชีพ
              และความเป็นผู้นำให้กับนิสิตมหาวิทยาลัยเกษตรศาสตร์ วิทยาเขตศรีราชา
            </p>
            <p className="mt-1.5 text-sm leading-relaxed text-gray-500">
              เปิดโอกาสให้นิสิตทุกชั้นปีและทุกคณะสมัครเข้าร่วม
              เพื่อเติบโตไปพร้อมกันในสภาพแวดล้อมที่เอื้อต่อการพัฒนา
            </p>
          </div>
        </div>
      </div>
